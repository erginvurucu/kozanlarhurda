      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <nav aria-label="Kırıntı yolu" className="text-sm text-kurum-500">
          <ol className="flex flex-wrap items-center gap-1.5">
            ...
            <li>
              <Link href={`/${ilce.slug}`} className="hover:text-lacivert-600">
                {ilce.ad}
              </Link>
            </li>
            <li aria-hidden="true">/</li>
            <li className="font-medium text-kurum-700">{mahalle.ad}</li>
          </ol>
        </nav>
        ...
        <div className="mt-8 grid gap-12 lg:grid-cols-[1fr_400px]">
          <article>
            ...
            <section className="mt-12">
              ...
              <p className="mt-4 leading-relaxed text-kurum-700">
                {mahalle.profil}
              </p>
            </section>

            <section className="mt-10 evrak zemin-kareli p-6">
              <h2 className="text-lg font-bold text-lacivert-900">
                {ilce.ad} geneli
              </h2>
              ...
              <Link
                href={`/${ilce.slug}`}
                className="mt-4 inline-block font-semibold text-lacivert-600 underline underline-offset-4"
              >
